...
export default {
  name: "Actions",
  components: {MobileBookmarks, Badge, Bookmarks, AlertMsg, AddRecipeIcon, BookmarksIcon, NavButton},
  setup() {
    ...
    const openMobileBookmarks = () => {
      dispatch('bookmarks/openMobileBookmarks')
    }
